...
export default function Sidebar({ session, tab, setTab, menuOpen, toggleMenu }: NavbarProps){
...
const mobileDisplay = windowWidth < 1440?(
    <nav
    ref={navRef} 
    className= 
    {menuOpen ? 
...
// This is for both desktop and mobile for now may be changed later...
