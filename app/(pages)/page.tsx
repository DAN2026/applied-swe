    ...
    return (
        <div className="w-full">
          ...
          <div className="relative w-full py-28 md:py-36 px-6 md:px-16 text-center overflow-hidden">
            ...
            <div id="about" className="absolute inset-0 -z-10">
              <Image
          ...
          <div id="charities" className="w-full py-20 px-6 md:px-16 text-center bg-linear-to-b from-emerald-700 to-green-600">
          ...
          <div
  id="contact"
  className="w-full flex flex-col items-center bg-linear-180 from-emerald-700/80 to-emerald-500 text-white px-6 md:px-16 py-20"
>
  ...
  <p className="text-lg md:text-xl flex items-center gap-3">
   ...
   <p className="text-lg md:text-xl flex items-center gap-3">
    ...
    sustainwear.info2025@gmail.com
  </p>

  <p className="text-white mt-4 text-center max-w-xl">
    For any questions about donations, partnerships, or support,
